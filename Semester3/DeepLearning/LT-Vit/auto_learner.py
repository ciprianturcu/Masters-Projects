...
LOG_FILE = os.path.join(os.path.dirname(__file__), "auto_training_log.xlsx")


def parse_args():
    parser = argparse.ArgumentParser(description="Evolutionary HP search for LT-ViT")
    parser.add_argument("--dry-run", action="store_true", help="Quick test with 100 images")
...
def main():
    ...
    print("=" * 60)
    print("  LT-ViT Evolutionary Hyperparameter Search")
    print("=" * 60)
